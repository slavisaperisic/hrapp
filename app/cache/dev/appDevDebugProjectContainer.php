...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hrdb', 'user' => 'root', 'password' => 'elefant11', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9de4abffc8ff06c0ba219b608d757b2f34a4fa676b4f79583f164e0a5b406ec6');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'paths' => array(($this->targetDirs[2].'/../src/AppBundle/Resources/views') => 'templatedir'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/../src/AppBundle/Resources/views'), 'templatedir');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('acfee37deb26628a7974a07a0df1c39c2ab5722f');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'hrdb',
            'database_user' => 'root',
            'database_password' => 'elefant11',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'acfee37deb26628a7974a07a0df1c39c2ab5722f',
            'locale' => 'en',
            ...
            'kernel.secret' => 'acfee37deb26628a7974a07a0df1c39c2ab5722f',
